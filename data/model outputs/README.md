...
lgbm_metrics_by_season.csv (there is one in each of the dated folders) contains performance metrics for LightGBM models that predict college basketball game outcomes. Each row shows the season, the metric name, and the value.
